// SV-model with leverage and standardized t distributed epsilon
...
SEPARABLE_FUNCTION void sf3(const dvariable& h_i, const dvariable& ls_x, const dvariable& Nu, int i)
  ...
  g -=  gammln(0.5*(Nu+1.0)) - gammln(0.5*Nu) -  0.5*log(Nu-2) - 0.5723649429;	// Constant in t(0,1)-distribution (speedup by moving this out).

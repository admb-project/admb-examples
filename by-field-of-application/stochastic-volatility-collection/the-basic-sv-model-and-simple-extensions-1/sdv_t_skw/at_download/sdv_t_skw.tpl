//SV-model with leverage and skewed t-distributed epsilon
...
PARAMETER_SECTION
  ...
  init_bounded_number lambda(-.9999,.9999,2)    // Autoregressian parameter
...
SEPARABLE_FUNCTION void sf3(const dvariable& h_i, const dvariable& ls_x, const dvariable& Nu, const dvariable& Lambda, int i)
  ...
  dvariable t = y(i)/SD_yIh;                    // Quantity which has skewed t-distribution
